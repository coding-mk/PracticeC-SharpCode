...
namespace MaximumAbsoluteDifference
{
    public class Program
    {
        ...
        {
            int[] A = { 1, 3, -1 };
            int result = MaxAbsoluteDifference(A);
            Console.WriteLine(result);
            int[] B = { 2 };
            int result2 = MaxAbsoluteDifference(B);
            Console.WriteLine(result2);
        }

        public static int MaxAbsoluteDifference(int[] A)
        {
            int maxSum = A[0], minSum = A[0], maxDiff = A[0], minDiff = A[0];
